...
namespace Draygo.API
{
	...
	public class HUDTextAPI
	{
		...
		public struct HUDMessage
		{
			...
			public HUDMessage(long messageid, int timetolive, Vector2D Origin, string Message, double Scale = 0.75d, bool HideHud = true, bool Shadowing = false, Color? ShadowColor = null)
			{
				id = messageid;
				ttl = timetolive;
				origin = Origin;
