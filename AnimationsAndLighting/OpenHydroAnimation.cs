...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "Hydroponics2")]
    public class OpenHydroAnimation : MyGameLogicComponent
    {
        ...
        private IMyCubeBlock openHydroponics = null;
        ...
        public override void UpdateAfterSimulation()
        {
            ...
            try
            {
                if (!openHydroponics.Storage.ContainsKey(ColorCheckStorageGUID) && RECOLOR_BLOCKS)
                {
