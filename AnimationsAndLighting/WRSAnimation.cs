...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "WRS", "WRSSmall")]
    public class WRSAnimation : MyGameLogicComponent
    {
        ...
        private IMyRefinery waterRecyclingSystem = null;
        ...
        public override void Init(MyObjectBuilder_EntityBase objectBuilder)
        {
            try
            {
                ...
                waterRecyclingSystem = Entity as IMyRefinery;
        ...
        public override void UpdateAfterSimulation()
        {
            try
            {
                ...
                if (!waterRecyclingSystem.Storage.ContainsKey(ColorCheckStorageGUID) && RECOLOR_BLOCKS)
                {
