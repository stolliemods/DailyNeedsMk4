...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Assembler), false, "Kitchen", "KitchenSmall")]
    public class FoodProteinResequencer : MyGameLogicComponent
    {
        ...
        private IMyCubeBlock foodProteinResequencer = null;
        ...
        public override void UpdateAfterSimulation()
        {
            try
            {
                ...
                if (!foodProteinResequencer.Storage.ContainsKey(ColorCheckStorageGUID) && RECOLOR_BLOCKS)
                {
