...
namespace Stollie.DailyNeeds //Just change this to something for yourself like 'namespace Kreeg.something'
{
    ...
    useEntityUpdate: false, entityBuilderSubTypeNames: "CropGrower")] //This is just SubtypeId from the .SBC file.
    public class SoilTrayAnimation : MyGameLogicComponent
    {
        private IMyAssembler soilTray = null;
        private MyObjectBuilder_EntityBase objectBuilder = null; //Ignore
        ...
        public override void Init(MyObjectBuilder_EntityBase objectBuilder)
        {
            ...
            soilTray = Entity as IMyAssembler;
        ...
        public override void UpdateAfterSimulation()
        {
            ...
            if (!soilTray.Storage.ContainsKey(ColorCheckStorageGUID) && RECOLOR_BLOCKS)
            {
