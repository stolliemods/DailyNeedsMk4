...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "Hydroponics", "HydroponicsSmall")]
    public class EnclosedHydroAnimation : MyGameLogicComponent
    {
        ...
        private IMyCubeBlock enclosedHydroponics = null;
        ...
        public override void UpdateAfterSimulation()
        {
            try
            {
                ...
                if (!enclosedHydroponics.Storage.ContainsKey(ColorCheckStorageGUID) && RECOLOR_BLOCKS)
                {
